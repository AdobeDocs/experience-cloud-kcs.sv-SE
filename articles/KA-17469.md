...
<br><br><br><br> <br><br>1. Installera den senaste CFP/SP<br><br><br><br> <br><br>
De senaste snabbkorrigeringarna finns på [Paketresurs för Adobe](https://www.adobeaemcloud.com/content/packageshare.html).
<br><br><br><br> <br><br>2. Kör konsekvenskontroll för datalager<br><br><br><br> <br><br>
Använda `oak-run` jar 1.6.6 och senare kör du följande kommando:
...
<br><br><br><br> <br><br>3. Skapa en lista med sökvägar för de saknade filerna<br><br><br><br> <br><br>
...
a. <b>I [!DNL Linux] eller [!DNL Unix]:</b> Använd det här kommandot om du vill visa en lista över saknade filer i en fil *missing_ds_files.txt*:
<br><br><br><br><br> <br><br><br><br>
...
\*\* Om Adobe Experience Manager-instansen inte startas på grund av felet &quot;blobId&quot; söker du i loggfilerna under `crx-quickstart/logs` för alla förekomster av felet&quot;Error occurred while obtain InputStream for blobId&quot; i stället:
<br><br><br><br><br> <br><br><br><br>
...
<br><br><br><br><br> <br><br>
b. <b>I [!DNL Windows]:</b>  Använda en textredigerare som [!DNL Textpad] eller [!DNL Notepad++] om du vill söka efter alla förekomster av &quot;Det gick inte att hitta posten&quot;.  När du har hittat alla sådana förekomster extraherar du filnamnen med ett makro, skriver ett skript eller genom att kopiera och konstruera filnamnen manuellt i en ny textfil.
...
<br><br><br><br> <br><br>4. Återställa de saknade filerna<br><br><br><br> <br><br>
...
I [!DNL Linux]kan du logga in på var och en av de fungerande Adobe Experience Manager-instanserna och använda ett kommando som t.ex. synkronisera för att kopiera över de filer som saknas i dem.  Genom att köra den från datalagrets katalog på servern som har de saknade filerna:
<br><br><br><br><br> <br><br><br><br>
...
<br><br><br><br><br> <br><br>
Kommandot kör en synkronisering som kopierar över alla filer som anges i `missing_ds_files.txt` som finns på servern.
<br><br><br><br> <br><br>5. Rensa oåterkalleliga filreferenser<br><br><br><br> <br><br>
...
<br><br><br><br> <br><br>6. Indexera om alla asynkrona ekindex<br><br><br><br> <br><br>
Eftersom indexfiler lagras i Oak-databasen kan det också vara möjligt att vissa filer saknas i `/oak:index` lucene-baserade index.

De saknade filerna rapporteras inte i `/system/console/repositorycheck` konsekvenskontroll när de döljs för databasgenomgångar.  Tyvärr matchar inte sådana filer i olika AEM.
...
1. Hämta `oak-run` 1.0.x matchar den version du har installerad i Oak-miljön: [https://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/](https://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/)

2. Överför `oak-run` till Adobe Experience Manager-servern.
...
<br><br><br><br><br> <br><br>
5. Starta Adobe Experience Manager igen och övervaka loggfilerna för INFO-loggmeddelanden från `org.apache.jackrabbit.oak.plugins.index`.  Om du vill se mer information om indexeringen går du till `/system/console/slinglog` Användargränssnitt och aktivera felsökningsnivåloggning för `org.apache.jackrabbit.oak.plugins.index`.
