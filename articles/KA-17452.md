...
- Om kommandot jstack (<b>jstack -l pid threaddumps.log</b>) returnerar felet 1 nedan och kör sedan kommandot som den användare som äger java-processen.  Exempel:
...
<br>ALTERNATIVA SÄTT ATT FÅ EN TRÅDDUMP<br>
...
<br>UNIX, Mac OS X och Linux (JDK 1.4 eller senare)<br>
