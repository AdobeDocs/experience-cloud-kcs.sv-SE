...
AEM på Premise 6.5.15

## Beskrivning {#description}


Kunden har en AEM miljö som är konfigurerad för de två författarna, utgivarna och utskickarna. Det finns en aktiv och en i vänteläge och utgivare och utgivare och utgivare har hög tillgänglighet.
...
Efter den här åtgärden kunde kunden komma åt den sekundära. När allt var bra ändrades författarna som förut.

Samma procedur användes en gång till, nästa dag som den sekundära författaren aktiverades, men den var inte tillgänglig eftersom de certifikat som importerades tidigare inte var tillgängliga
