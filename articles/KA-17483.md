...
Nu vet webbservern att en domän är något som ska generera trafik för, men vi måste ändå informera utgivarmodulen om att den har ett nytt domännamn som ska respekteras.  Vi börjar med att skapa en ny \*_vhost.any-fil /etc/httpd/conf.dispatcher.d/vhosts/weretail_vhosts.any..
