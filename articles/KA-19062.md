...
1. Utför en rensning av kontrollpunkter genom att lista kontrollpunkter med hjälp av nedan. Om det finns fler än en kontrollpunkt ska du rensa upp dem:
   ...
   ```
2. Kör en offlinekomprimering.  Om du inte vet hur du kör offlinekomprimering kan du se [här](https://gist.github.com/andrewmkhoury/0b1fe4d8b619178ff87b).
3. Starta servern och vänta på att indexeringen ska slutföras.
