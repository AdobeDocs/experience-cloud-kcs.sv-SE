---
title: "Storleken på ett begäranrubrikfält överskrider servergränsen"
description: "Lär dig hur du löser felet \"Felaktig begäran\" när du öppnar en sida i AEM."
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: "KCS, storlek, begäranhuvud, överskrid, servergräns, AEM, Adobe Experience Manager, felsökning, AEMaaCS, Adobe Experience Manager as a Cloud Service"
...
När en sida öppnas får användarna ett<b>Felaktig begäran</b>&quot; svar med meddelandet:

&quot;<b>*Storleken på ett begäranderubrikfält överskrider servergränsen</b>*&quot;
...
Apache has a default `LimitRequestLine` of *8K*. Mer information finns i [Huvudfunktioner i Apache: LimitRequestLine-direktivet](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) på Apache-webbplatsen.

Det här felet kan åtgärdas genom att öka värdet för `#LimitRequestFieldSize` och `#LimitRequestLine`.

<u>För AMS/lokal</u>:

Rubrikgränsen kan ökas i konfigurationsfilen för Apache - `httpd.conf`.



<u>För AEMaaCS</u>:

Öka gränsen för begärandehuvud genom att lägga till egenskaperna ovan i Vhost-filerna:
