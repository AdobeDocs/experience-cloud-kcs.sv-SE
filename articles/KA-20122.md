...
  namn: droppable-typ: Booleskt värde: true

Anpassningsexempel Ett PathField med droppable=true som läggs till i HelloWorld-komponenten i WKND-självstudiekursen, t.ex. /apps/wknd/components/helpWorld/cq:dialog/content/items/column/items/path: 
