...
description: Lär dig vilka begäranden som AEM skickas till.
...
1. Avsändaren kan skicka och ta emot 200 OK-svar från en av de definierade RENDERS-alternativen.
   ...
   | HTTP-begäran:<br><br>    200 OK | cache |
   | --- | --- |
...
2. Inga av dessa svarshuvuden finns med i svaret:
   ...
   | HTTP-svar:<br><br>    200 OK<br><br>    Dispatcher: ingen cache | inte cachelagrad |
   | --- | --- |
   | HTTP-svar:<br><br>    200 OK<br><br>    Cache-control: no-cache | inte cachelagrad |
   | HTTP-svar:<br><br>    200 OK<br><br>    Pragma: ingen cache | inte cachelagrad |
   | HTTP-svar:<br><br>    200 OK | cache |
...
3. Värdet för innehållslängd är större än ZERO BYTES.
   ...
   | HTTP-svar:<br><br>    200 OK<br><br>    Innehållslängd: 0 | inte cachelagrad |
   | --- | --- |
   | HTTP-svar:<br><br>    200 OK<br><br>    Content-Length: 3120 | cache |
