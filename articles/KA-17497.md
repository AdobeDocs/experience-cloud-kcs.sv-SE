...
4. Begäran nekas av /CACHE = /REGLER som definieras i dispatchern. EVENTUELL GRUPPKONFIGURATION.
   ...
   | <br><br>    ```<br>    Farm has /cache = /rules and a request is received for /content/test.html<br>    <br>    /cache<br>    <br>    {<br>    <br>     ...<br>    <br>     /rules<br>    <br>     {<br>    <br>      /0001 {<br>    <br>      type "deny"<br>    <br>      glob "*"<br>    <br>      }<br>    <br>     }<br>    <br>    }<br>    ```<br><br> | inte cachelagrad |
   | --- | --- |
   | <br><br>    ```<br>    Farm has /cache = /rules and a request is received for /content/test.html<br>    <br>    /cache<br>    <br>    {<br>    <br>     ...<br>    <br>     /rules<br>    <br>     {<br>    <br>      /0001 {<br>    <br>      type "allow"<br>    <br>      glob "*"<br>    <br>      }<br>    <br>     }<br>    <br>    }<br>    ```<br><br> | cachelagrad |
...
5. HTTP-begäran innehåller inte någon auktoriseringshuvud eller så innehåller den rubriken, men /ALLOWAUTHZED är inställd på 1 i FARM CONFIGURATION.
   ...
   | HTTP-begäran:<br><br>    ```<br>    GET /content/test.html HTTP/1.1<br>    Authorization: Basic YWxhZGRpbjpvcGVuc2VzYW1l<br>    <br>    dispatcher.any farm /cache = /allowAuthorized configuration:<br>    <br>    /cache {<br>      <br>     /allowAuthorized “0”<br>    }<br>    ```<br><br> | inte cachelagrad |
   | --- | --- |
   | HTTP-begäran:<br><br>    ```<br>    GET /content/test.html HTTP/1.1<br>    Authorization: Basic YWxhZGRpbjpvcGVuc2VzYW1l<br>    <br>    dispatcher.any farm /cache = /allowAuthorized configuration:<br>    <br>    /cache {<br>      <br>     /allowAuthorized “1”<br>    }<br>    ```<br><br> | cachelagrad |
...
6. HTTP-begäran innehåller LOGIN-TOKEN eller Authorization COOKIE i cookie-huvudet eller innehåller någon (eller båda) av dessa cookies och /ALLOWAUTHZED är inställd på 1 i FARM CONFIGURATION.
   ...
   | HTTP-begäran:<br><br>    ```<br>    GET /content/test.html HTTP/1.1<br>    Cookie: login-token=…<br>    <br>    dispatcher.any farm /cache = /allowAuthorized configuration:<br>    <br>    /cache {<br>      <br>     /allowAuthorized “0”<br>    }<br>    ```<br><br> | inte cachelagrad |
   | --- | --- |
