---
title: Kolumnordning ändras i [!DNL Analytics] Arbetsyta över tid
...
# Kolumnordning ändras i [!DNL Analytics] Arbetsyta över tid
...
Som standard i [!UICONTROL Workspace], när en kund ger en dimension till kolumnerna (som [!UICONTROL Day of Week] här) exploderar den till de fem populäraste dynamiska objekten för den dimensionen. Om kunden inte vill att de ska ändras med tiden måste de högerklicka på dem och välja &quot;[!UICONTROL Make item static]&quot;.
