...
description: "Läs mer om Adobe Experience Manager-problemet där meddelandet inte är internationaliserat."
...
Problemet är ett meddelande som inte är internationaliserat. Felmeddelandet&quot;Invalid date - The value must be of date datatype&quot; är på engelska, även om det ska vara på tyska, som är kundens webbläsarspråk.

Om du tittar på tyska klientlib /libs/fd/af/runtime/clientlibs/I18N/de/javascript/LogMessages.js vi att meddelandet är på engelska och dessutom har en platshållare {0}, vilket betyder att en del av meddelandet är dynamiskt.
