...
Orsaken till problemet är att användarens XML-kod saknar ett kritiskt argument för godkännande av innehåll (`useContentValidation`) och många andra. Den är skadad.

Användarvalideringen ser ut så här.
...
Om användaren vill kopiera leveranser på det här sättet kontrollerar du alla godkännandetaggar i XML-filen innan du skickar.
