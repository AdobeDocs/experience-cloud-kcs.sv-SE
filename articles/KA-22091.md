---
title: "Pipeline misslyckades med felet \"Egenskapen end_aem_createsegmentstore saknas\""
...
# Pipeline misslyckades med felet &quot;Egenskapen end_aem_createsegmentstore saknas&quot;

## Beskrivning {#description}

CI/CD-pipelinen slutar fungera under driftsättningsfasen. <br><br>Distributionsloggarna visade inga fel på grund av kodbasen men följande fel finns:<br><br> <br><br> <br><br> <br><br>`[` 1`]`  
...
När du kontrollerar pipelinen kan du se att den misslyckas med felet &quot;errorCode&quot;: &quot;BLOCKED_QUEUE&quot;.

Detta innebär att replikeringskön blockeras vilket förhindrar installationen av ytterligare ändringsbart innehåll.

I loggarna visas felen `[` 1`]`  finns under distributionstiden. Troligtvis noden - `[` 2`]`  finns inte på utgivaren och/eller förhandsgranskningsservern och replikeringen misslyckas.

Efter rensning av replikeringskön lyckades pipeline-distributionen.
