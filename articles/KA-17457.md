...
2. Kontrollera på operativsystemsnivå om den AEM Java-processen ger hög processoranvändning:        Om AEM ger hög processoranvändning kör du det körklara profileringsverktyget i några minuter och analyserar resultatet.
...
4. Granska underhållsrutinerna för ditt system. Se det här [artikel](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/monitoring-and-maintaining.html)r för mer information om AEM och se till att du utför rätt underhåll på AEM, inklusive:
...
<br> <b>Resursprestandaproblem</b><br> 
...
2. Om problemet beror på att arbetsflödena inte fungerar som de ska kan du granska den aktuella [tips för arbetsflödesbearbetning](https://experienceleague.adobe.com/docs/experience-manager-65/developing/extending-aem/extending-workflows/workflows-process-ref.html?lang=en).
