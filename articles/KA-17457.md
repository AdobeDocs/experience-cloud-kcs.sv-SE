---
title: "Vanliga viktiga AEM problem"
...
AEM Sites Performance Issues<br>
...
2. Kontrollera på operativsystemsnivå om den AEM Java-processen ger hög processoranvändning:    
...
4. Granska underhållsrutinerna för ditt system. Se det här [artikel](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/monitoring-and-maintaining.html)om du vill ha information om AEM och se till att du utför rätt underhåll på AEM, inklusive: - Revision Clean Up (MongoMK och Database DocumentNodeStore’s only) - day or more frequency - Offline tar Compaction (endast tarMK) - bi-week - Data Store Garbage Collection (endast system med FileDataStore eller S3 DataStore) - week - Workflow Purge - week - Version Renge - week - AuditLog Renge - week 5. Granska cachelagringsstrategier som implementerats på AEM-dispatchernivå.
6. Granska webbplatsens cachning.
...
<br> AEM Assets Performance Issues<br> 
...
När du har hämtat en Heap Dump-fil öppnar du den i [Eclipse MAT](http://www.eclipse.org/mat/) eller [IBM Memory Analyzer](https://developer.ibm.com/languages/java/) verktyg.  I Eclipse MAT kör du Leak Suspects-rapporten och öppnar vyn &quot;Thread Details&quot; (Trådinformation) för att se möjliga orsaker till minnesproblemet.
...
1. Öppna de här URL-adresserna på AEM om du vill visa statistik om den asynkrona indexeraren http://aemhost:port/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dasync%2Ctype%3DIndexStats http://aemhost:port/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dfulltext-async%2Ctype%3DIndexStats  - This gäller endast för AEM6.2 och senare
