...
2. Välj knappen Lägg till ny loggare
3. Fyll i följande värden och välj sedan knappen &quot;spara&quot;

Exempelkonfiguration:    - loglevel = DEBUG - logfile = logs/activity.log - logger = org.apache.jackrabbit.vault.packaging.impl.ActivityLog
