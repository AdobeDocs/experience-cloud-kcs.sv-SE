---
title: "[!UICONTROL File collector] aktivitetsalternativ i ACS"
...
# [!UICONTROL File collector] aktivitetsalternativ i ACS

## Beskrivning

Som vi inte har [!UICONTROL File collector] i ACS kan du bygga det med följande aktiviteter så får du mer eller mindre samma funktionalitet
...
The [!UICONTROL File collector] kan hämta flera filer baserat på filnamnsmönster från en extern server. Varje fil skickas till [!UICONTROL Load file] aktivitet, ge data till uppdateringen.
När du är klar fortsätter den med följande fil och så vidare.
Filöverföringen har även [!UICONTROL Historization settings]som du vet det av [!UICONTROL File collector].
