...
2. Lägg till den här nodversionen som <b>devDependencies</b> i `package.json` filen för modulen som inte gick att skapa. I exemplet ovan är det UI-teckensnitt.
