---
title: "Det går inte att välja Adobe Target som molnlösning för en IMS-konfiguration"
...
# Det går inte att välja Adobe Target som molnlösning för en IMS-konfiguration
...
Kunden försöker skapa en Adobe Target IMS-konfiguration för att integrera AEM med Adobe Target.

När de väljer&quot;Adobe Target&quot; som molnlösning för IMS-konfigurationen visas felet&quot;Det går inte att hämta certifikat: Det angivna användar-ID:t identifierar inte en befintlig användare&quot; och konfigurationen kan inte skapas.

Problemet gäller endast Adobe Target.



Steg som ska återskapas:

1. Gå till verktyg `>`  Säkerhet `>`  IMS-konfigurationer `>`  Skapa
2. Välj Target som lösning

Du får ett felmeddelande i gränssnittet &quot;Det går inte att hämta certifikatet. Angiven userid identifierar inte en befintlig användare.&quot;

I loggarna är det enda felet som rör det här problemet `[` 1`]` .
...
När behörigheterna för användarna &quot;target-imsconfig-service&quot; och &quot;target service&quot; kontrollerades, observerades att target-imsconfig-service inte hade några tilldelade ACE:er.
...
Sökväg: /home/users/system/target-imsconfig-service

Behörighet: tillåt

Behörighet: jcr:read; rep:write
