...
I min Target-aktivitet har jag skapat en *Konverteringsmått* målgruppsanpassning *mbox* ovan. Jag har en raffinerad publik som kräver ett värde i *CTA Click* parameter. Se skärmbilderna nedan som beskriver detta:
...
Använd <b>Klickad på mbox</b> metod som du måste omsluta *mbox* runt CTA och låt användaren faktiskt klicka på det. Jag tycker att du borde försöka <b>Visad mbox</b> när du skjuter *mbox* när de har klickat på den.
