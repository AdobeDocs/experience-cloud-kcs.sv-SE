...
Efter att ha skapat konfigurationen för SAML 2.0 för att aktivera SSO-inloggning i sin produktion Författaren fick kunden ett felmeddelande från AEM efter att Azure-providern utförde inloggningen och hämtade SAML-token för att utföra autentiseringen på AEM.<br><br> <br><br>Det mottagna felet var `[` 1`]` <br><br> <br><br><b>`[` 1`]`  \*FEL\* `[` qtp1558388453-153215`]`  SAML-svarsparametern com.adobe.granite.auth.saml.SamlAuthenticationHandler har inte angetts eller är ogiltig.</b>
...
Fel 403 visas vanligtvis om referensfiltret för Apache Sling inte är aktiverat. Kontrollerar konfigurationen för referensfiltret för Apache Sling-referens. Alternativet Tillåt tomt har inte markerats och ingen värd har lagts till i Tillåt värdar
...
När du har slutfört dessa obligatoriska steg - kontrollera&quot;Tillåt tomt&quot; och lägg till värdarna som representerar IdP-providern till&quot;Tillåt värdar&quot;. Inloggningen lyckades.



OBS!

IDP-URL:en måste läggas till i konfigurationen för Apache Sling Referrer-filtret utan att inkludera protokollet - t.ex. aem-sso-saml i stället för https://aem-sso-saml
