...
Dokumentet beskriver vanliga loggposter som du kommer att se, vad de betyder och hur du hanterar dem.<br><br>[Innehållsförteckning](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17490.html)
...
Sedan [!DNL dispatcher] Moduel 4.2.x som de började avråda människor från att använda följande typ av matchningar i sina filterfiler:
...
Förstå att [!DNL dispatcher]Regler har angetts för att filtrera bort den begäran. I det här fallet avvisades sidan med avsikt och vi vill inte göra något med det.
...
Detta inträffar när du har konfigurerat fel IP-adress i återgivningsavsnittet i servergruppen. Den eller den AEM instansen slutade svara eller lyssna och [!DNL dispatcher] Jag kan inte nå det.
...
Det innebär att AEM hade en öppen socket som den kunde nå och nådde en tidsgräns med svaret. Det innebär att AEM var för långsam eller ohälsosam och [!DNL dispatcher] har nått den konfigurerade timeoutinställningarna i renderingssektionen i servergruppen. Öka timeoutinställningen eller få AEM felfri.
...
Det här felet inträffar när du har konfigurerat [!DNL dispatcher] om du vill använda det dynamiska autofiltret för att tillåta URL:er för innehållshantering, men inte slutföra installationen genom att installera paketet på den AEM renderaren.
