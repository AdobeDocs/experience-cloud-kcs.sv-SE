...
<b><u>Förändringar i GraphQL hantering av <em>null</em> values</u></b><br><br> <br><br>I version 2023.02.11382 har vissa förbättringar gjorts i GraphQL-implementeringen som kan orsaka oväntat beteende i programkoden om den förlitade sig på det felaktiga beteendet i de äldre versionerna. 
...
Den sista utgåvan är också relaterad till *null* värden i filtervillkor i flervärdesfält. Använd lägesINSTANSER med _instanser: 0 matchar inte innehållsfragmenten som innehåller *null* värden i respektive fält före 2023.02.11382, men börjar med 2023.02.11382. Vi rekommenderar att du testar frågor som använder den här konstellationen och ändrar dem om de inte returnerar det förväntade resultatet som angavs i 2023.02.11382 längre.
<b>Exempel:</b>
