...
PipelineExecutionFailureReasons anger dock en &quot;ASSETS_TESTS_AUTHOR_CONNECTION_ERROR&quot; med felkoden &quot;002_010_006&quot; och meddelandet:

`Unable to connect to the author instance. `
  
Intern information tyder på ett HTTP-svarsproblem med ett meddelande som anger &quot;Hittades inte&quot;, vilket vanligtvis innebär att det inte gick att nå slutpunkten för författarinstansen under testkörningen.
...
Molnhanteringsanvändaren finns dock och manuell överföring av resurser på författaren fungerar som förväntat.

Prestandatestet för tillgångarna fungerar i 30 minuter och misslyckas sedan plötsligt på ett upprepat sätt medan testet ska avslutas efter 30 minuter - `[` 1`]`
...
När den interna Azure-funktionen loggas hittades begäran med resultatet 404 Hittades inte.

GETEN till URL:en från meddelandefältet returnerade 404 `[` 1`]` .

Misslyckandet i det här fallet berodde på att querybuilder blockerades på avsändarnivå efter Adobe rekommendation.

Cloud Manager måste dock tillåta frågeverktyget för den som skickar molnhanteraren, eftersom bearbetningstiden hämtas under resurstestningen.
