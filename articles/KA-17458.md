...
7. <b>Aktivera [/serveStaleOnError](https://helpx.adobe.com/experience-manager/kb/ServeStaleContentOnError.html)</b> i `/cache` configuration - serva den gamla cachefilen när AEM instanser hanterar fel.
