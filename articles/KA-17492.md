...
description: "Lär dig hur du analyserar AEM indexeringsproblem."
...
I den här artikeln beskrivs hur du analyserar långsamma frågor, indexerar om asynkrona index och felsöker AEM indexeringsproblem.
...
- Om omindexeringen inte är fullständig och har gått in i en slinga, se avsnittet nedan under rubriken [Analysen misslyckades med omindexering](https://helpx.adobe.com/experience-manager/kb/Analyzing-AEM-Indexing-Issues.html#Analyzing_Failed_Reindexing).
...
1. Aktivera loggning för att validera timing:
   ...
   Loggar som dessa skulle genereras med tidsangivelsen för indexering:
...
6. Gå till denna URL `/system/console/configMgr/org.apache.jackrabbit.oak.plugins.index.lucene.LuceneIndexProviderService` &quot;Copy on Read&quot;, &quot;Copy on Write&quot; (only safe to use in Oak 1.0.18 and later) och &quot;Prefetch Index Files&quot; (only in Oak 1.0.18 and later)
