---
title: Analyssegment avpubliceras inte även om det inte finns några AAM målmappningar.
...
# Analyssegment avpubliceras inte även om det inte finns några AAM målmappningar.
...
Om du är bekant med AAM API:t kan du med andra ord se om problemet är detsamma som du står inför genom att göra en [Hämta segment efter segment-ID](https://bank.demdex.com/portal/swagger/index.html#/Segments%20API/get_segments__sid_) -kommando med frågesträngsparametern includedInUseStatus inställd på true för det aktuella publicerade AA-segmentet. Då visas alla målmappningar. Om noden &quot;pairedTraitSegments&quot; visas i noden &quot;mappedEntities&quot; i svaret vet du att den underliggande egenskapen delas med andra manuellt skapade segment. ID:n i noden&quot;pairedTraitSegments&quot; är ID:n för alla segment som använder samma egenskap.
