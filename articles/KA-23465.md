...
Replikeringskön blockeras regelbundet för en av våra AEMaaCS-kunder. I den här artikeln beskrivs den lösning som föreslås av konstruktionsgruppen och som kan utföras i användargränssnittet med administratörsbehörighet.
...
En av våra AEMaaCS-kunders replikeringskö blockeras regelbundet på grund av javax.jcr.NamespaceException: Okänt namnområdesprefix: ns22_ undantag.
...
Du måste ta bort begäran från användargränssnittet för den gyllene publiceringskön för att få bort blockeringen av kön. Föreslå att kunden utför stegen nedan.
