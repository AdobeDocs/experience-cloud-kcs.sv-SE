...
- Använd <b>Följ TCP-strömmen</b> för att isolera den ström du arbetar med.<br><br>    Stäng det röda/blå textfönstret som visas eftersom det bara är användbart för textprotokoll som inte är relevanta för SMPP.
