...
- Använd ett visningsfilter på porten för SMS-C.<br>\
   Om SMS-C till exempel använder port 10000 använder du följande filter:
   `tcp.port == 10000`
...
- Använd<b>Följ TCP-ström</b> för att isolera den ström du arbetar med.<br>\
