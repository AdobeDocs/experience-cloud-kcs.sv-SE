...
<br>Lär dig hur du analyserar SMPP-trafik med Wireshark.<br><br><br><br><br>Introduktion<br><br><br><br> <br><br>
...
Den här artikeln ersätter inte den här specifikationen: Det ger praktiska tips om hur man tolkar protokollspecifikationen och matchar den med Wirehak-skärmen för att hjälpa till att felsöka problem mellan Adobe Campaign och SMS-C-partnern.
...
<br><br>Hämta nätverkstrafik utan Wireshark<br><br><br><br><br><br>
...
<br><br>Hantering av trådhaj<br><br><br><br> <br><br><br><br>
...
Det finns en tidsgräns för svar, vanligtvis 10, 30 eller 60 sekunder. Svaret kan innehålla en positiv bekräftelse (command_status = 0) eller ett fel (se 5.1.3 *command_status*, *tabell 5-2* i SMPP-specifikationen för listan över standardfel). Vanligtvis är dessa svar omedelbara och ingen tidsgräns för svar nås.
