---
title: "Om cachelagring | AEM"
description: "Lär dig hur dispatcher-cachning sker och hur den kan konfigureras i Adobe Experience Manager."
...
I den här artikeln får du lära dig hur dispatchercachelagring sker och hur du kan konfigurera det med hjälp av följande standardcachekataloger i dina baslinjeinstallationer -
...
Kom ihåg att AEM fortfarande måste konfigureras för att skicka TTL-rubriker för att dispatchern ska kunna följa dem. Om du växlar den här funktionen kan avsändaren bara veta när de filer som AEM har skickat cachekontrollrubriker ska tas bort. Om AEM inte börjar skicka TTL-rubriker gör inte avsändaren något särskilt här.
