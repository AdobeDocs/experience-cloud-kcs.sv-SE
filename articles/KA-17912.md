...
Om du har sidor i AEM som `GET` argument/frågeparametrar på adressraden som hjälper sidan att fungera, men som inte återger olika HTML-koder, passar bra för det här konfigurationselementet. Du kan se [!DNL dispatcher] vilka argument som ska ignoreras och fortfarande cachelagra sidan.
