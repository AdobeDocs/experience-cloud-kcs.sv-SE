...
| 1<br>  2<br>  3<br>  4<br>  5<br>  6<br>  7<br>  8<br>  9<br>  10<br>  11<br>  12<br>  13<br>  14<br>  15<br>  16<br>  17<br>  18 | `Inkludera``/etc/httpd/conf``.d``/variables/weretail``.vars``VirtualHost *:80``    ``ServerName   ``&quot;${MAIN_DOMAIN}&quot;``    ``Katalog /``        ``Inkludera``/etc/httpd/conf``.d``/whitelists/weretail``*_whitelist.rules``        ``IfModule disp_apache2.c``            ``....SNIP....``            ``SetHandler dispatcher-handler``        ````/IfModule````        ``....SNIP....``    ````/Directory````    ``....SNIP....``    ``IfModule mod_rewrite.c``        ``ReWriteEngine på``        ``LogLevel Warning rewrite:trace1``        ``Inkludera``/etc/httpd/conf``.d``/rewrites/weretail_rewrite``.rules&quot;&quot;/IfModule&quot;/VirtualHost&quot; |
| --- | --- |
...
Nu tittar vi på <b>/etc/httpd/conf.dispatcher.d/filters/weretail_search_filters.any</b>:
<br><br><br><br><br> <br><br><br><br>
