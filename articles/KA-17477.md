...
![inkluderingsordning för apache-baslinjen. binärfilen för apache börjar med httpd.conf, som inte kan inkluderas i conf.d/*.conf och conf.modules.d/*.conf-kataloger](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/Apache-Webserver-Baseline-Includes.png)
...
![virtuella värdar för team innehåller underobjekt. Den här bilden visar hur en .vhost-fil innehåller filer från variabler, vitlistor och mappar som skrivs om](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/Apache-Webserver-AMS-Vhost-Includes.png)
