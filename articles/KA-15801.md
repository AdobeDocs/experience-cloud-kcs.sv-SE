---
title: Campaign Standard - Spara en målgrupp från ett arbetsflöde som har en [!UICONTROL Fork] aktivitet, orsakar ett fel i målgruppen
...
# Campaign Standard - Spara en målgrupp från ett arbetsflöde som har en [!UICONTROL Fork] aktivitet, orsakar ett fel i målgruppen

## Beskrivning


När vi sparar en målgrupp från ett arbetsflöde som har en [!UICONTROL Fork] -aktivitet, returneras ett fel i målgruppen vid kontroll av antal.
...
Avmarkera <b>[!UICONTROL Keep all additional data from the main set] </b>och <b>Lägg till [!UICONTROL Line number]</b> aktivitet.
