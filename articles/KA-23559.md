---
title: "Fel när diamap skapades"
description: "Ett fel visas när en diamap skapas"
...
# Ett fel uppstod när en diamap skapades
...
Följ de här stegen för att lösa problemet med att skapa en fjärrmapp:

1. Navigera till <b>verktyg `>`  Stödlinjer `>`  Dokumentlägen</b> i AEM.
